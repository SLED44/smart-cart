...
PANE_HEIGHT = 620  # iframe height; two columns scroll independently inside it.
...
<style>
  * {{ box-sizing: border-box; }}
  ...
  .col > .scroll {{ overflow-y: auto; padding: 10px 14px 18px; }}
